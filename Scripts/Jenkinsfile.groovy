...
pipeline {
    ...
    environment {
        ...
        def dllsToDeployAnyCPU = 'Intel.RealSense log4net MathNet.Numerics MetriCam2 MetriCam2.Cameras.RealSense2 MetriCam2.Cameras.Kinect4Azure MetriCam2.Controls Metrilus.Util Newtonsoft.Json'
